...
- Endeavors are now called `One Time Achievements` and they're no longer technically not quests. Turns out what I thought wasn't possible with the quests plugin **is** possible and I just failed to realize (survival)
